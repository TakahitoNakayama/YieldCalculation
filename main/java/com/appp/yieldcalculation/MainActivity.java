...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        culcButton=findViewById(R.id.bt_culc);
        culcButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EditText number2 = findViewById(R.id.et_accumulation_amount);//ナンバー２(積立金額入力欄)を変数にする
                ...
                EditText number3 = findViewById(R.id.et_yield);//ナンバー３(想定利回り入力欄)を変数にする
